...
PalladiumEvents.registerAnimations((event) => {
    event.registerForPower('scan_mode/look', 'omni_extras:not_aliens/scan_mode', 200, (builder) => {
        let activation = animationUtil.getAnimationTimerAbilityValue(
            builder.getPlayer(), 'omni_extras:not_aliens/scan_mode', 'dummy', builder.getPartialTicks());
