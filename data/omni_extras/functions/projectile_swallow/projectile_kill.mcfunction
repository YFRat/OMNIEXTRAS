...
kill @e[type=minecraft:wither_skull,distance=..3]

energybar value add @s omni_extras:perkgourmand stomach 150
energybar value add @s omni_extras:murkgourmand stomach 150